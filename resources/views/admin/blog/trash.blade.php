...
<div class="content-header row">
    <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
        <h3 class="content-header-title mb-0 d-inline-block">Trashed Blogs</h3>
    </div>
    <div class="content-header-right col-md-6 col-12">
        <div class="btn-group float-md-right">
            ...
            <a class="btn btn-info mb-1" href="{{ route('admin.blog.index') }}">Back to Active Blogs</a>
        </div>
    </div>
</div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Deleted Blogs</h4>
                </div>
...
CRUDManager.init({
    ...
    entity: 'blog',
    routes: {
        data: "{{ route('admin.blog.trash.data') }}",
        restore: "{{ route('admin.blog.restore', ':id') }}",
        forceDelete: "{{ route('admin.blog.forceDelete', ':id') }}",
