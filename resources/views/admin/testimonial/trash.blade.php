...
<div class="content-header row">
    <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
        <h3 class="content-header-title mb-0 d-inline-block">Trashed Testimonials</h3>
    </div>
    <div class="content-header-right col-md-6 col-12">
        <div class="btn-group float-md-right">
            ...
            <a class="btn btn-info mb-1" href="{{ route('admin.testimonial.index') }}">Back to Active Testimonials</a>
        </div>
    </div>
</div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Deleted Testimonials</h4>
                </div>
...
CRUDManager.init({
    ...
    entity: 'testimonial',
    routes: {
        data: "{{ route('admin.testimonial.trash.data') }}",
        restore: "{{ route('admin.testimonial.restore', ':id') }}",
        forceDelete: "{{ route('admin.testimonial.forceDelete', ':id') }}",
